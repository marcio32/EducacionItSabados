...
namespace Infrastructure.Repositorys
{
    public class RolesRepository : IRolesRepository
    {
        ...
        public async Task<IEnumerable<Roles>> GetAllAsync() => await _dbContext.Roles.ToListAsync();
        public async Task<IEnumerable<Roles>> GetRolesActiveAsync() => await _dbContext.Roles.Where(x=> x.Estado == true).ToListAsync();
